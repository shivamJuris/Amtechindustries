      ...
      <form onSubmit={onSubmitHandler}>
        <div className='mb-3 min-w-72'>
         ...
         <div className='mb-3 min-w-72'>
            ...
            <input onChange={(e)=>setPassword(e.target.value)} value={password} type="password" className="rounded-md w-full px-3 py-2 border border-gray-300 outline-none" placeholder='Your@Password' required/>
        </div>
