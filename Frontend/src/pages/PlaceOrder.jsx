    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t '>
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className="flex gap-3">
          {/* placeholder content or remove this line if not needed */}
          {/* <p className="text-gray-500">Delivery form will go here</p> */}
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <button onClick={()=>navigate('/order')} className='bg-black text-white px-16 py-3 text-sm rounded-lg '>PLACE ORDER</button>
